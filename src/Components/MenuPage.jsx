...
const MenuPage = () => {
  ...
  const [quantities, setQuantities] = useState({}); // State to track quantity of each item
  ...
  const increaseQuantity = (itemName) => { // Use item name
  ...
  const decreaseQuantity = (itemName) => { // Use item name
    setQuantities((prevQuantities) => ({
      ...prevQuantities,
